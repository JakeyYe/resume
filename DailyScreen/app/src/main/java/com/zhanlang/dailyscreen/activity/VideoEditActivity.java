...
public class VideoEditActivity extends AppCompatActivity {
    ...
    private TextView videoEditSave;
...
//                + File.separator + "DailyScreen" + File.separator + "2.mp4";
        //for video check
    ...
    private void initView() {
        //title bar上的文件保存按钮
        videoEditSave= (TextView) findViewById(R.id.video_edit_save);
        videoEditSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //TODO 根据left/rightProgress和MP4PaserUtil保存文件
                Toast.makeText(VideoEditActivity.this, "left/rightProgress "+leftProgress+" "
                        +rightProgress, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        public void onRangeSeekBarValuesChanged(RangeSeekBar bar, long minValue, long maxValue, int action, boolean isMin, RangeSeekBar.Thumb pressedThumb) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    isSeeking = false;
                    //从minValue开始播
                    Log.i(TAG, "onRangeSeekBarValuesChanged: left right "+leftProgress+" "+rightProgress);
                    mVideoView.seekTo((int) leftProgress);
//                    videoStart();
                    break;
                default:
